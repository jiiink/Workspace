...
class FullAddException : public ExceptionError {
    public:
        void Print() {
            cout << "Full Table Exception" << endl;
        }
};
class EmptyException : public ExceptionError {
    public:
        void Print() {
            cout << "Empty Table Exception" << endl;
        }
};
class EmptyDeleteException : public EmptyException {
    public:
        void Print() {
            cout << "Empty table Delete Exception." << endl;
        }
};
class EmptySearchException : public EmptyException {
    public:
        void Print() {
            cout << "Empty Search Exception." << endl;
        }
};
class EmptyPrintException : public EmptyException {
    public:
        void Print() {
            cout << "Empty Print Exception." << endl;
        }
};
    ...
    if (IsDuplicate(p)) {
        ...
        if (topRecordTable < tableMaxSize) {
            if (count < capacity) {
                ...
                topRecordTable++;
                if (topRecordTable >= tableMaxSize) { //테이블이 크기를 넘어설 때 동작
                    topRecordTable--;
                    throw FullAddException();
                }
                count = 0;
...
void RecordTable<T>::Print() {
    if (count == 0) throw EmptyPrintException();
    for (int i=0; i<=topRecordTable; i++) {
        data[i]->Print();
    }
}
...
int main() {
    ...
    RecordTable<Employee> etable(1, 5);//10개의 record sets, 각 set은 5개의 records
    ...
    while (1)
    {
        ...
        case 2:
            ...
            catch (EmptyPrintException error) {
                error.Print();
            }
            break;
        case 3:
            ...
            catch (EmptySearchException error) {
                error.Print();
            }
        ...
        case 4:
            ...
            catch (EmptyDeleteException error) {
                error.Print();
            }
            break;
        default:
