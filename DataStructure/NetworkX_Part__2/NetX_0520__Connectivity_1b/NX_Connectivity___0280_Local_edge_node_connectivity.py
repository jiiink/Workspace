...
lec = local_edge_connectivity(G, 4, 9) #networkX에는 없음
lnc = local_node_connectivity(G, 4, 9)

a49 = is_locally_k_edge_connected(G, 4, 9, 2)
a89 = is_locally_k_edge_connected(G, 8, 9, 2)
print(f" a49= {a49}, a89= {a89}")

print(f"lec={lec}, lnc={lnc}")
