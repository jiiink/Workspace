...
public:
  ...
  bool operator==(const self& other) const {     // test for equality
     return current == other.current;
  }

  bool operator!=(const self& other) const { // test for inequality
     return current != other.current;
  }
  ...
  void report(ostream& o) const   { // Display statistics on stream o
