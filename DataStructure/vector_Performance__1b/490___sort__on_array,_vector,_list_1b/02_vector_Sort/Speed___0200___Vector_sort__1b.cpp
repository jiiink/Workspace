...
/*  2021.5.6 comments
   ...
   3개의 알고리즘을 섞어 사용하나. 그 3개는 QuickSort, HeapSort and InsertionSort이다.
   기본적으로는 QuickSort를 사용하는데 QuickSort가 pivoting에 최악의 경우를 걸릴 것으로
   짐작되면, 즉 N*logN이상 걸릴 것이라고 예상되면 HeapSort을 사용하고
   그 크기가 최종적으로 충분히 적을 경우에는 InsertionSort( )로 전환한다.
*/
