...
/*  2021.5.6 comments
   ...
   즉 N*log N이상 걸릴 것이라고 예상되면 worst case O(N log N)인 HeapSort을 사용한다.
   또는 recursive depth를 일정단계까지만 하고 나머지는 더 이상 recursion을 부르지 않는다.    Quick 단계의 크기가 충분히 적을 경우에는 더 이상 divide하지 않고
...
#define Lsize 6      // 크기를 5배씩  늘임.
long    N[ Lsize ] = { 100000, 500000, 2500000, 12500000, 62500000, 312500000 } ;
