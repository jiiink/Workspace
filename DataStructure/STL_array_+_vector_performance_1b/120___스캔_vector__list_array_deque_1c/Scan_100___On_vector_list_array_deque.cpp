...
int main() {
    ...
    cout << "\n begin-end for loop scan myarray[]: " << milgap.count() ;
    ...
    tend = time.now();
    milgap = duration_cast<Milsec>(tend -tbegin);
    cout << "\n begin-end for loop scan myvec[] : " << milgap.count() ;
    ...
    tend = time.now();
    milgap = duration_cast<Milsec>(tend -tbegin);
    cout << "\n begin-end for loop mydeque[] :" << milgap.count() ;
    ...
    tend = time.now();
    milgap = duration_cast<Milsec>(tend -tbegin);
    cout << "\n begin-end for loop mylist[]  : " << milgap.count() ;


    cout << "\n\n >> STL range-based looping 실험 \n " ;
    tbegin = time.now();
      for(int i=1; i<= 10 ; ++i)  {
    ...
    tend = time.now();
    milgap = duration_cast<Milsec>(tend -tbegin);
    cout << "\n Range-based scan myarray[ ] : " << milgap.count() ;
    ...
    cout << "\n Range-based scan myvec[ ]    : " << milgap.count();
    ...
    tend = time.now();
    milgap = duration_cast<Milsec>(tend -tbegin);
    cout << "\n Range-based scan  mydeque[ ]  : " << milgap.count();
    ...
    tend = time.now();
    milgap = duration_cast<Milsec>(tend -tbegin);
    cout << "\n Range-based scan  mylist[ ]    : " << milgap.count() ;
