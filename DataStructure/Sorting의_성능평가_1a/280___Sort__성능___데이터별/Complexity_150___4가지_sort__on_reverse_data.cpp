...
void set_reverse_vector(){    // 실험용 float vector 배열을 만듬.
    ...
    float fval =100000  ;
        for(long i=0; i < N[lindex] ; i++){
             V[ lindex ].push_back( fval - (double)i ) ;
        }
...
int main(){
    ...
    printf("\n\n Insert_sort( )를 사용한 reverse data sorting 시간") ;
    set_reverse_vector( ) ;
    ...
    printf("\n\n Select_sort( )를 사용한 reverse data sorting 시간") ;
    set_reverse_vector( ) ;
    for(int i=0 ; i <= Lsize-1; i++ ){
         mybegin = chrono::system_clock::now();
            select_sort( V[i] ) ;
    ...
    printf("\n\n Quick sort( )를 사용한 reverse data sorting 시간") ;
    set_reverse_vector( ) ;
    for(int i=0 ; i <= Lsize-1; i++ ){
         mybegin = chrono::system_clock::now();
    ...
    printf("\n\n Generic sort( )를 사용한 reverse data sorting 시간") ;
    set_reverse_vector( ) ;
    for(int i=0 ; i <= Lsize-1; i++ ){
         mybegin = chrono::system_clock::now();
