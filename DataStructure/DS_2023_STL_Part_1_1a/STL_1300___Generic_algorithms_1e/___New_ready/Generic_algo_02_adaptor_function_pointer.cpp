...
int main() {
  ...
  cout << "Illustrating the use of an adaptor for pointers to functions." << endl;
  typedef set<string, pointer_to_binary_function<const string&,
                                   const string&, bool> >  set_type1;
