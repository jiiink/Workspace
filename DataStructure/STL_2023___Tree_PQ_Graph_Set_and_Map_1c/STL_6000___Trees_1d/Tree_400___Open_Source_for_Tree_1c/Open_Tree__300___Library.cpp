...
bool truefunc(string& one, string& two) { //	cout << "comparing " << one << "==" << two << endl;
    return true;
}
...
int main(int argc, char **argv) {
    ...
    for(unsigned int j=0; j<maxloop; ++j) {
        ...
        cout << "No.1 empty tree to begin with:" << endl;
